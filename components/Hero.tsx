...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center" style={{ padding: 'clamp(2rem, 6vw, 8rem) clamp(2rem, 8vw, 10rem)' }}>
      <div className="w-full mx-auto" style={{ maxWidth: '1400px', width: '100%' }}>
        <div className="grid grid-cols-2 items-end" style={{ gap: 'clamp(5rem, 10vw, 12rem)' }}>
          {/* Left: Video Frame */}
          <div className="w-full flex items-center" style={{ paddingRight: '4%' }}>
            <VideoFrame videoSrc="/landing-page-video.mp4" />
          </div>

          {/* Right: Headline, Bullets, CTA */}
          <div className="w-full flex flex-col justify-start relative" style={{ paddingLeft: '4%', paddingTop: '0', minHeight: '100%' }}>
            {/* Headline */}
            <h1 
