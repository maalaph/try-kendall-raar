...
// lib/voiceMapping.ts
function getElevenLabsMapping(vapiVoiceName) {
  return VAPI_TO_ELEVENLABS_MAPPING[vapiVoiceName] || null;
}
var VAPI_TO_ELEVENLABS_MAPPING;
var init_voiceMapping = __esm({
  "lib/voiceMapping.ts"() {
    "use strict";
    init_esm();
    VAPI_TO_ELEVENLABS_MAPPING = {
    ...
    __name(getElevenLabsMapping, "getElevenLabsMapping");
  }
});
...
//# sourceMappingURL=chunk-OP6AZBK3.mjs.map
